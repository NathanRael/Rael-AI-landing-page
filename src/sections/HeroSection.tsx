...
const HeroSection = () => {
    ...
    return (
        <section className={'flex flex-col items-center justify-center gap-20 w-full px-10 max-[600px]:px-2 pt-40 '}>
            <div className="flex flex-col justify-center items-center gap-10">
                <div className={'flex flex-col items-center justify-center gap-4'}>
                    <div className={'flex flex-col items-center justify-center'}>
                        <p className={'text-lead text-white-100'}>Developed by <span
                            onClick={() => window.open(MY_GITHUB_PROFILE, '_blank')}
                            className={'underline cursor-pointer'}>Natanael R</span>
                        </p>
                        <h1 className={"text-big-title max-md:text-title text-center text-white-100"}>Your Go-to Solution For Using <span
                            className={' p-1 bg-neutral-dark-60 rounded-xl'}>Ollama</span></h1>
                    </div>
                    <p className={'text-lead text-white-100/80 text-center'}>Experience the power of Ollama locally with
                        a sleek, intuitive UI for seamless chatting--available on both web and desktop</p>
                </div>
